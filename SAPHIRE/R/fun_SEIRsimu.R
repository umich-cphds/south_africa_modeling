...
#' @param flowN_vec               daily inbound and outbound size during four periods (n)
#' @param init_states             initial c(S, E, P, I, A, H, R)
...
SEIRsimu <- function(pars, init_settings, num_periods = 5) {
  ...
  stage_start <- c(1, 13, 48, 78)               # corresponding to dates
  stage_end <- c(12, 47, 79,length(days_to_fit))    # corresponding to dates(could vary)
  ##
